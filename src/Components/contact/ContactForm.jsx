        ...
        <form onSubmit={(e) => {
            ...
            >
                ...
                <div className='font-general-regular'>
                    <label className='block text-lg text-primary-dark dark:text-primary-light mb-2' htmlFor='name'> Full Name</label>
                    <input 
                ...
                <div className='mt-6 font-general-regular'>
                    <label className='block text-lg text-primary-dark dark:text-primary-light mb-2' htmlFor='subjet'>Subject</label>
                ...
                <div className='font-general-medium w-40 px-4 py-2.5 text-white text-center font-medium tracking-wider bg-indigo-500 hover:bg-indigo-600 focus:ring-1 focus:ring-indigo-900 rounded-lg mt-6 duration-500'>
                    <button title='Send Message' type='submit' aria-label='Send Message'>Send Message</button>
                </div>
